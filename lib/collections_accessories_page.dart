...
class CollectionsAccessoriesPage extends StatefulWidget {
  const CollectionsAccessoriesPage({super.key});

  @override
  State<CollectionsAccessoriesPage> createState() => _CollectionsAccessoriesPageState();
}

class _CollectionsAccessoriesPageState extends State<CollectionsAccessoriesPage> {
  ...
  Widget build(BuildContext context) {
    var products = ProductService.getProductsByCategory('accessories');
